  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        scrolled
          ? 'bg-white/80 backdrop-blur-xl shadow-soft border-b border-primary-200/30'
          : 'bg-transparent'
      }`}
    >
        ...
        <div className="flex justify-between items-center h-16">
          ...
          >
            ...
            >
              <Link
                to="/contact"
                className="relative overflow-hidden bg-accent hover:bg-accent-dark text-white px-6 py-2.5 rounded-xl font-body font-medium transition-all duration-300 shadow-medium hover:shadow-large group"
              >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="md:hidden bg-white/95 backdrop-blur-xl border-t border-primary-200/30"
          >
